...
export default function CashierCustomerCards() {
  ...
  const load = () => {
    setLoading(true);
    const params = { sort: 'cust_surname' };
  ...
  return (
    <div className="page">
      <div className="page-header">
        ...
        <button className="btn btn-primary" onClick={openCreate}>+ Нова картка</button>
      </div>
      ...
      <div className="filters">
        <div className="filter-group">
          ...
          <input type="text" value={surname} onChange={(e) => setSurname(e.target.value)} placeholder="Прізвище клієнта..." />
        </div>
      </div>
      ...
      {modal && (
        <Modal title={modal.mode === 'create' ? 'Нова картка клієнта' : 'Редагувати картку'}
          ...
          <div className="form-row">
            ...
            <div className="form-group"><label>Знижка, %</label><input type="number" min="0" max="100" value={form.percent} onChange={f('percent')} /></div>
          </div>
          <div className="form-row">
